...
public class HelloWorldJavaFX extends Application{
    ...
    public void start(Stage palco){
        ...
        clip.play();
        //Personagem
        Rectangle ceu = new Rectangle(600, 450, Color.ORANGERED);
        Rectangle mar = new Rectangle(600, 450, Color.DARKBLUE);
        Rectangle ceu2 = new Rectangle(600, 450, Color.YELLOW);
        Rectangle mar2 = new Rectangle(600, 450, Color.LIGHTBLUE);
        ...
        FadeTransition ft = new FadeTransition(Duration.millis(20000), ceu);
            ...
            ft.play();
        FadeTransition mt = new FadeTransition(Duration.millis(20000), mar);
            mt.setFromValue(2.0);
            mt.setToValue(0.5);
